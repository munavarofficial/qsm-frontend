  ...
  const handleSubmitStaff = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${backendUrl}/api/principal/create-class-notification/`,
        formData,
        {
          headers: {
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600 mt-1 ms-2">
                               Send important updates and announcements to Student
                              </p>
                            </div>
                          </div>
                        </div>
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <div className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-xl hover:border-purple-500 hover:bg-purple-50 transition-all duration-200">
                    ...
                    <span className="text-xs text-gray-400 mt-1">MP3, WAV, M4A up to 25MB</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              >
                {isSubmitting ? (
                  ...
                  <>
                    ...
                    <span className="text-xs md:text-base">Send Notification</span>
                  </>
                )}
              </button>
